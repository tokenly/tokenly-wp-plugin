...
use Tokenly\Wp\Controllers\Admin\DashboardController as DashboardAdminController;
use Tokenly\Wp\Controllers\Admin\SettingsController as SettingsAdminController;
use Tokenly\Wp\Controllers\Admin\UserController as UserAdminController;
use Tokenly\Wp\Controllers\Admin\PostController as PostAdminController;
use Tokenly\Wp\Controllers\Admin\TermController as TermAdminController;
use Tokenly\Wp\Controllers\Admin\Credit\GroupController as CreditGroupAdminController;
use Tokenly\Wp\Controllers\Admin\Credit\TransactionController as CreditTransactionAdminController;
use Tokenly\Wp\Controllers\Admin\Credit\VendorController as CreditVendorAdminController;
use Tokenly\Wp\Controllers\Admin\Token\AddressController as TokenAddressAdminController;
use Tokenly\Wp\Controllers\Admin\Token\SourceController as TokenSourceAdminController;
use Tokenly\Wp\Controllers\Admin\Token\VendorController as TokenVendorAdminController;
use Tokenly\Wp\Controllers\Admin\Token\PromiseController as TokenPromiseAdminController;
use Tokenly\Wp\Controllers\Admin\Token\WhitelistController as TokenWhitelistAdminController;
use Tokenly\Wp\Controllers\Admin\Token\MetaController as TokenMetaAdminController;
use Tokenly\Wp\Controllers\Admin\Token\CategoryTermController as TokenCategoryTermAdminController;
...
use Tokenly\Wp\Controllers\Api\Credit\VendorController as CreditVendorApiController;
...
use Tokenly\Wp\Controllers\Api\Token\VendorController as TokenVendorApiController;
...
use Tokenly\Wp\Policies\Admin\Credit\GroupPolicy as CreditGroupPolicy;
use Tokenly\Wp\Policies\Admin\Credit\TransactionPolicy as CreditTransactionPolicy;
use Tokenly\Wp\Policies\Admin\Credit\VendorPolicy as CreditVendorPolicy;
use Tokenly\Wp\Policies\Admin\Token\AddressPolicy as TokenAddressPolicy;
use Tokenly\Wp\Policies\Admin\Token\CategoryTermPolicy as TokenCategoryTermPolicy;
use Tokenly\Wp\Policies\Admin\Token\MetaPolicy as TokenMetaPolicy;
use Tokenly\Wp\Policies\Admin\Token\PromisePolicy as TokenPromisePolicy;
use Tokenly\Wp\Policies\Admin\Token\SourcePolicy as TokenSourcePolicy;
use Tokenly\Wp\Policies\Admin\Token\VendorPolicy as TokenVendorPolicy;
use Tokenly\Wp\Policies\Admin\Token\WhitelistPolicy as TokenWhitelistPolicy;
...
use Tokenly\Wp\Presentation\Blocks\Credit\ItemCardListBlockModel as CreditItemCardListBlockModel;
use Tokenly\Wp\Presentation\Blocks\Token\ItemCardListBlockModel as TokenItemCardListBlockModel;
...
use Tokenly\Wp\Presentation\Components\Credit\ItemCardComponentModel as CreditItemCardComponentModel;
use Tokenly\Wp\Presentation\Components\Token\ItemCardComponentModel as TokenItemCardComponentModel;
...
use Tokenly\Wp\Presentation\Views\Admin\Credit\GroupWhitelistEditViewModel as CreditGroupWhitelistEditViewModel;
...
use Tokenly\Wp\Presentation\Views\Admin\Token\CategoryTermEditViewModel as TokenCategoryTermEditViewModel;
...
use Tokenly\Wp\Presentation\Shortcodes\Credit\BalanceShortcode as CreditBalanceShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Credit\InventoryShortcode as CreditInventoryShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Token\BalanceShortcode as TokenBalanceShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Token\InventoryShortcode as TokenInventoryShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Token\MetaShortcode as TokenMetaShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Token\MetaAttributesShortcode as TokenMetaAttributesShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Token\MetaMediaShortcode as TokenMetaMediaShortcode;
use Tokenly\Wp\Presentation\Shortcodes\Token\MetaInfoShortcode as TokenMetaInfoShortcode;
...
use Tokenly\Wp\Repositories\Credit\GroupWhitelistRepository as CreditGroupWhitelistRepository;
...
use Tokenly\Wp\Repositories\Token\CategoryTermRepository as TokenCategoryTermRepository;
...
use Tokenly\Wp\Repositories\Token\WhitelistRepository as TokenWhitelistRepository;
...
use Tokenly\Wp\Services\Application\Credit\VendorService as CreditVendorService;
use Tokenly\Wp\Services\Application\Token\VendorService as TokenVendorService;
use Tokenly\Wp\Services\Application\Token\Access\CheckerService as TokenAccessCheckerService;
use Tokenly\Wp\Services\Application\Token\Access\MenuItemFilterService as TokenAccessMenuItemFilterService;
use Tokenly\Wp\Services\Application\Token\Access\PostCheckerService as TokenAccessPostCheckerService;
use Tokenly\Wp\Services\Application\Token\Access\PostGuardService as TokenAccessPostGuardService;
use Tokenly\Wp\Services\Application\Token\Access\PostResultsFilterService as TokenAccessPostResultsFilterService;
use Tokenly\Wp\Services\Application\Token\Access\TermCheckerService as TokenAccessTermCheckerService;
use Tokenly\Wp\Services\Application\Token\Access\TermGuardService as TokenAccessTermGuardService;
...
use Tokenly\Wp\Services\Application\Routers\Columns\PostRouter as PostColumnRouter;
use Tokenly\Wp\Services\Application\Routers\Columns\UserRouter as UserColumnRouter;
...
use Tokenly\Wp\Interfaces\Collections\Token\Access\RuleCheckResultCollectionInterface as TcaRuleCheckResultCollectionInterface;
use Tokenly\Wp\Interfaces\Collections\Token\Access\RuleCollectionInterface as TcaRuleCollectionInterface;
use Tokenly\Wp\Interfaces\Collections\Token\AddressCollectionInterface as TokenAddressCollectionInterface;
use Tokenly\Wp\Interfaces\Collections\Token\AssetCollectionInterface as TokenAssetCollectionInterface;
...
use Tokenly\Wp\Interfaces\Controllers\Api\Credit\VendorControllerInterface as CreditVendorApiControllerInterface;
...
use Tokenly\Wp\Interfaces\Controllers\Api\Token\VendorControllerInterface as TokenVendorApiControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\DashboardControllerInterface as DashboardAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\SettingsControllerInterface as SettingsAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\UserControllerInterface as UserAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\PostControllerInterface as PostAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\TermControllerInterface as TermAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Credit\GroupControllerInterface as CreditGroupAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Credit\TransactionControllerInterface as CreditTransactionAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Credit\VendorControllerInterface as CreditVendorAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\AddressControllerInterface as TokenAddressAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\PromiseControllerInterface as TokenPromiseAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\SourceControllerInterface as TokenSourceAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\VendorControllerInterface as TokenVendorAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\WhitelistControllerInterface as TokenWhitelistAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\MetaControllerInterface as TokenMetaAdminControllerInterface;
use Tokenly\Wp\Interfaces\Controllers\Admin\Token\CategoryTermControllerInterface as TokenCategoryTermAdminControllerInterface;
...
use Tokenly\Wp\Interfaces\Policies\Admin\Token\CategoryTermPolicyInterface as TokenCategoryTermPolicyInterface;
use Tokenly\Wp\Interfaces\Policies\Admin\Token\MetaPolicyInterface as TokenMetaPolicyInterface;
...
use Tokenly\Wp\Interfaces\Presentation\Blocks\Credit\ItemCardListBlockModelInterface as CreditItemCardListBlockModelInterface;
use Tokenly\Wp\Interfaces\Presentation\Blocks\Token\ItemCardListBlockModelInterface as TokenItemCardListBlockModelInterface;
...
use Tokenly\Wp\Interfaces\Presentation\Components\Credit\ItemCardComponentModelInterface as CreditItemCardComponentModelInterface;
use Tokenly\Wp\Interfaces\Presentation\Components\Token\ItemCardComponentModelInterface as TokenItemCardComponentModelInterface;
...
use Tokenly\Wp\Interfaces\Presentation\Views\Admin\Credit\GroupWhitelistEditViewModelInterface as CreditGroupWhitelistEditViewModelInterface;
...
use Tokenly\Wp\Interfaces\Presentation\Views\Admin\Token\CategoryTermEditViewModelInterface as TokenCategoryTermEditViewModelInterface;
...
use Tokenly\Wp\Interfaces\Repositories\Credit\GroupWhitelistRepositoryInterface as CreditGroupWhitelistRepositoryInterface;
...
use Tokenly\Wp\Interfaces\Services\Application\Credit\VendorServiceInterface as CreditVendorServiceInterface;
...
use Tokenly\Wp\Interfaces\Services\Application\Routers\Listings\PostRouterInterface as PostColumnRouterInterface;
use Tokenly\Wp\Interfaces\Services\Application\Routers\Listings\UserRouterInterface as UserColumnRouterInterface;
use Tokenly\Wp\Interfaces\Services\Application\Token\VendorServiceInterface as TokenVendorServiceInterface;
use Tokenly\Wp\Interfaces\Services\Application\Token\Access\CheckerServiceInterface as TokenAccessCheckerInterface;
...
use Tokenly\Wp\Interfaces\Services\Application\Token\Access\PostCheckerServiceInterface as TokenAccessPostCheckerServiceInterface;
...
use Tokenly\Wp\Interfaces\Services\Application\Token\Access\TermCheckerServiceInterface as TokenAccessTermCheckerServiceInterface;
...
return array(
	...
	QueryServiceInterface::class                      => \DI\autowire( QueryService::class )
		->constructorParameter( 'namespace', \DI\get( 'general.namespace' ) ),
	CreditVendorServiceInterface::class                  => \DI\autowire( CreditVendorService::class ),
	TokenVendorServiceInterface::class                   => \DI\autowire( TokenVendorService::class ),
	TokenAccessCheckerServiceInterface::class            => \DI\autowire( TokenAccessCheckerService::class ),
	TokenAccessMenuItemFilterServiceInterface::class     => \DI\autowire( TokenAccessMenuItemFilterService::class ),
	TokenAccessPostGuardServiceInterface::class          => \DI\autowire( TokenAccessPostGuardService::class )
		->constructorParameter( 'namespace', \DI\get( 'general.namespace' ) ),
	TokenAccessPostResultsFilterServiceInterface::class  => \DI\autowire( TokenAccessPostResultsFilterService::class )	
		->constructorParameter( 'namespace', \DI\get( 'general.namespace' ) ),
	TokenAccessPostCheckerServiceInterface::class        => \DI\autowire( TokenAccessPostCheckerService::class ),
	TokenAccessTermCheckerServiceInterface::class        => \DI\autowire( TokenAccessTermCheckerService::class ),
	TokenAccessTermGuardServiceInterface::class          => \DI\autowire( TokenAccessTermGuardService::class )
		->constructorParameter( 'namespace', \DI\get( 'general.namespace' ) ),
	...
	ApiRouterInterface::class      => \DI\autowire( ApiRouter::class )
		->constructorParameter( 'namespace', DI\get( 'general.namespace' ) ),
	PostRouterInterface::class     => \DI\autowire( PostRouter::class )
		->constructorParameter( 'namespace', DI\get( 'general.namespace' ) )
		->constructorParameter( 'brand', \DI\get( 'general.brand' ) ),
	TermRouterInterface::class     => \DI\autowire( TermRouter::class )
		->constructorParameter( 'namespace', \DI\get( 'general.namespace' ) )
		->constructorParameter( 'brand', \DI\get( 'general.brand' ) ),
	WebRouterInterface::class      => \DI\autowire( WebRouter::class )
		->constructorParameter( 'namespace', \DI\get( 'general.namespace' ) ),
	//Services - Application - Routers - Columns
	PostColumnRouterInterface::class     => \DI\autowire( PostColumnRouter::class )
		->constructorParameter( 'namespace', DI\get( 'general.namespace' ) ),
