...
import TransactionInterface
	from '../../Interfaces/Models/Credit/TransactionInterface'
...
import TransactionCollection
	from '../../Collections/Credit/TransactionCollection'
	...
	implements TransactionRepositoryInterface
{
	...
	public index(
		...
		return new Promise<TransactionCollectionInterface>( (
			resolve, reject
		) => {
			this.ApiService.creditTransactionIndex(
				params
			).then( ( result: any ) => {
