...
interface CreditGroupShowPageData {
	credit_group: any;
}

interface CreditGroupShowPageProps {
	pageData: CreditGroupShowPageData;
}

interface CreditGroupShowPageState {
	//
}

export default class CreditGroupShowPage extends Component<CreditGroupShowPageProps, CreditGroupShowPageState> {
	state: CreditGroupShowPageState = {
		//
	}
	constructor( props: CreditGroupShowPageProps ) {
		super( props );
	}
