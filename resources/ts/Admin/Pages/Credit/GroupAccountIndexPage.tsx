...
export default function GroupAccountIndexPage(
	props: GroupAccountIndexPageProps
) {
	...
	const [ accounts, setAccounts ] = 
		useState<AccountCollectionInterface>( null )
	...
	useEffect( () => {
		...
		groupRepository.accountIndex( group, params ).then( (
			accountsFound: AccountCollectionInterface
		) => {
	...
	return (
		<Page title={ dictionary.get( 'creditGroupAccountIndexTitle' ) }>
			<Panel>
				<PanelHeader>
					<Preloader loading={ loadingAccounts }>
						{ dictionary.get(
