...
use Tokenly\Wp\Interfaces\Controllers\Api\Credit\VendorControllerInterface as CreditVendorControllerInterface;
...
use Tokenly\Wp\Interfaces\Controllers\Api\Token\VendorControllerInterface as TokenVendorControllerInterface;
...
return function(
		...
		return array(
			...
			'credit_group_account_index' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $credit_group_controller, 'account_index' ),
				'permission_callback' => function () {
			...
			'credit_group_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $credit_group_controller, 'show' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_group_whitelist_update' => array(
				...
				'methods'             => 'PUT',
				'callback'            => array( $credit_group_controller, 'group_whitelist_update' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_group_update' => array(
				'path' => '/credit/group/{group}',
				'methods'             => 'PUT',
				'callback'            => array( $credit_group_controller, 'update' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_group_index' => array(
				'path' => '/credit/group',
				'methods'             => 'GET',
				'callback'            => array( $credit_group_controller, 'index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_group_store' => array(
				'path' => '/credit/group',
				'methods'             => 'POST',
				'callback'            => array( $credit_group_controller, 'store' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_transaction_index' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $credit_transaction_controller, 'index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_transaction_store' => array(
				'path' => '/credit/transaction',
				'methods'             => 'POST',
				'callback'            => array( $credit_transaction_controller, 'store' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_vendor_debit' => array(
				...
				'methods'             => 'POST',
				'callback'            => array( $credit_vendor_controller, 'debit' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'credit_vendor_credit' => array(
				...
				'methods'             => 'POST',
				'callback'            => array( $credit_vendor_controller, 'credit' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_balance_index' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $token_address_controller, 'balance_index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_verify' => array(
				...
				'methods'             => 'PUT',
				'callback'            => array( $token_address_controller, 'verify' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $token_address_controller, 'show' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_update' => array(
				'path' => '/token/address/{address}',
				'methods'             => 'PUT',
				'callback'            => array( $token_address_controller, 'update' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_destroy' => array(
				'path' => '/token/address/{address}',
				'methods'             => 'DELETE',
				'callback'            => array( $token_address_controller, 'destroy' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_index' => array(
				'path' => '/token/address',
				'methods'             => 'GET',
				'callback'            => array( $token_address_controller, 'index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_address_store' => array(
				'path' => '/token/address',
				'methods'             => 'POST',
				'callback'            => array( $token_address_controller, 'store' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			...
			'token_promise_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $token_promise_controller, 'show' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_promise_index' => array(
				'path' => '/token/promise',
				'methods'             => 'GET',
				'callback'            => array( $token_promise_controller, 'index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_promise_update' => array(
				'path' => '/token/promise/{promise}',
				'methods'             => 'PUT',
				'callback'            => array( $token_promise_controller, 'update' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_promise_store' => array(
				'path' => '/token/promise',
				'methods'             => 'POST',
				'callback'            => array( $token_promise_controller, 'store' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_promise_destroy' => array(
				'path' => '/token/promise/{promise}',
				'methods'             => 'DELETE',
				'callback'            => array( $token_promise_controller, 'destroy' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_vendor_promise' => array(
				...
				'methods'             => 'POST',
				'callback'            => array( $token_vendor_controller, 'promise' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_source_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $token_source_controller, 'show' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_source_update' => array(
				'path' => '/token/source/{source}',
				'methods'             => 'PUT',
				'callback'            => array( $token_source_controller, 'update' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_source_destroy' => array(
				'path' => '/token/source/{source}',
				'methods'             => 'DELETE',
				'callback'            => array( $token_source_controller, 'destroy' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_source_index' => array(
				'path' => '/token/source',
				'methods'             => 'GET',
				'callback'            => array( $token_source_controller, 'index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_source_store' => array(
				'path' => '/token/source',
				'methods'             => 'POST',
				'callback'            => array( $token_source_controller, 'store' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'token_whitelist_update' => array(
				...
				'methods'             => 'PUT',
				'callback'            => array( $settings_controller, 'update_token_whitelist' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'user_credit_balance_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $user_controller, 'credit_balance_show' ),
				'permission_callback' => function () {
					return true;
				},
			),
			'user_credit_balance_index' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $user_controller, 'credit_balance_index' ),
				'permission_callback' => function () {
					return true;
				},
			),
			'user_token_balance_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $user_controller, 'token_balance_show' ),
				'permission_callback' => function () {
					return true;
				},
			),
			'user_token_balance_index' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $user_controller, 'token_balance_index' ),
				'permission_callback' => function () {
					return true;
				},
			),
			'user_token_address_index' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $user_controller, 'token_address_index' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			...
			'integration_settings_show' => array(
				...
				'methods'             => 'GET',
				'callback'            => array( $settings_controller, 'show_integration' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'settings_show_oauth' => array(
				'path' => "/settings/oauth",
				'methods'             => 'GET',
				'callback'            => array( $settings_controller, 'show_oauth' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'settings_show_tca' => array(
				'path' => "/settings/tca",
				'methods'             => 'GET',
				'callback'            => array( $settings_controller, 'show_tca' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'settings_update_integration' => array(
				'path' => '/settings/integration',
				'methods'             => 'PUT',
				'callback'            => array( $settings_controller, 'update_integration' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'settings_update_oauth' => array(
				'path' => '/settings/oauth',
				'methods'             => 'PUT',
				'callback'            => array( $settings_controller, 'update_oauth' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
			'settings_update_tca' => array(
				'path' => '/settings/tca',
				'methods'             => 'PUT',
				'callback'            => array( $settings_controller, 'update_tca' ),
				'permission_callback' => function () {
					return current_user_can( 'manage_options' );
				},
			),
