...
export default function TransactionStorePage(
	props: TransactionStorePageProps
) {
	const adminPageUrl: string = useInjection(
		TYPES.Variables.adminPageUrl
	)
	...
	const vendorService: VendorServiceInterface = useInjection(
