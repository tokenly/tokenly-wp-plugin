...
export default class AddressRepository implements AddressRepositoryInterface {
	...
	public index(
		...
		return new Promise<AddressCollectionInterface>( (resolve, reject ) => {
			this.ApiService.tokenAddressIndex(
				params
			).then( ( result: any ) => {
	...
	public show(
		...
		return new Promise<AddressInterface>( ( resolve, reject ) => {
			this.ApiService.tokenAddressShow(
				id, params
			).then( ( result: any ) => {
	...
	public store(
		...
		return new Promise<any>( ( resolve, reject ) => {
			this.ApiService.tokenAddressStore( params ).then( (
				result: Array<any>
			) => {
				resolve( result )
			} ).catch( error => {
	...
	public update(
		...
		return new Promise<any>( ( resolve, reject ) => {
			this.ApiService.tokenAddressUpdate(
				id, params
	...
	public destroy( id: string ): Promise<Array<any>> {
		return new Promise<any>( ( resolve, reject ) => {
			this.ApiService.tokenAddressDestroy( id ).then( (
				result: Array<any>
			) => {
				resolve( result )
			} ).catch( error => {
	...
	public verify(
		...
		return new Promise<any>( ( resolve, reject ) => {
			this.ApiService.tokenAddressVerify(
				id, params
			).then( ( result: Array<any> ) => {
				resolve( result )
			} ).catch( error => {
	...
	public balanceIndex(
		...
		return new Promise<BalanceCollectionInterface>( (
			resolve, reject
		) => {
			this.ApiService.tokenAddressBalanceIndex(
				id, params
			).then( ( result: any ) => {
