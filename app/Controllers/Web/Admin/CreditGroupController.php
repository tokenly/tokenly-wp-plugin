...
class CreditGroupController implements CreditGroupControllerInterface {
	...
	protected $credit_group_store_view_model;
	...
	public function __construct(
		...
		CreditGroupStoreViewModelInterface $credit_group_store_view_model,
		...
		$this->credit_group_store_view_model = $credit_group_store_view_model;
	...
	public function store() {
		$view_data = $this->credit_group_store_view_model->prepare();
		return array(
